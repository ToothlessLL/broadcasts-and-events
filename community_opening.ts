...
CommunityOpening.title = '2025 Catalyst Leagues';
CommunityOpening.filename = '2025 Catalyst Leagues.png';
CommunityOpening.width = 1250;
...
broadcasts.get(`Barrows dye`).data = {count:47};
broadcasts.get(`Shadow dye`).data = {count:25};
broadcasts.get(`Ice dye`).data = {count:27};
broadcasts.get(`Third Age dye`).data = {count:11};
broadcasts.get(`Blood dye`).data = {count:8};
broadcasts.get(`Third age full helmet`).data = {count:1};
broadcasts.get(`Third age platebody`).data = {count:1};
broadcasts.get(`Third age platelegs`).data = {count:0};
broadcasts.get(`Third age kiteshield`).data = {count:0};
broadcasts.get(`Backstab cape`).data = {count:16};
broadcasts.get(`Third age mage hat`).data = {count:0};
broadcasts.get(`Third age robe top`).data = {count:2};
broadcasts.get(`Third age robe`).data = {count:0};
broadcasts.get(`Third age amulet`).data = {count:0};
broadcasts.get(`Sack of effigies`).data = {count:16};
broadcasts.get(`Third age ranger coif`).data = {count:0};
broadcasts.get(`Third age ranger body`).data = {count:0};
broadcasts.get(`Third age ranger chaps`).data = {count:2};
broadcasts.get(`Third age vambraces`).data = {count:0};
broadcasts.get(`Explosive barrel`).data = {count:3};
broadcasts.get(`Third age druidic wreath`).data = {count:4};
broadcasts.get(`Third age druidic robe top`).data = {count:4};
broadcasts.get(`Third age druidic robe bottom`).data = {count:4};
broadcasts.get(`Third age druidic staff`).data = {count:2};
broadcasts.get(`Third age druidic cloak`).data = {count:3};
broadcasts.get(`Second-Age full helm`).data = {count:1};
broadcasts.get(`Second-Age platebody`).data = {count:1};
broadcasts.get(`Second-Age platelegs`).data = {count:1};
broadcasts.get(`Second-Age sword`).data = {count:2};
broadcasts.get(`Orlando Smith's hat`).data = {count:5};
broadcasts.get(`Second-Age mage mask`).data = {count:0};
broadcasts.get(`Second-Age robe top`).data = {count:0};
broadcasts.get(`Second-Age robe bottom`).data = {count:0};
broadcasts.get(`Second-Age staff`).data = {count:1};
broadcasts.get(`Blank`).data = {count:0};
broadcasts.get(`Second-Age range coif`).data = {count:0};
broadcasts.get(`Second-Age range top`).data = {count:0};
broadcasts.get(`Second-Age range legs`).data = {count:0};
broadcasts.get(`Second-Age bow`).data = {count:1};
broadcasts.get(`Golden Compass`).data = {count:1};
...
doubleBroadcasts.push({name: 'Kyle T', item1: 'Third Age dye', item2: 'Barrows dye'});
doubleBroadcasts.push({name: 'Brucedawayne', item1: 'Sack of effigies', item2: 'Ice dye'});
doubleBroadcasts.push({name: 'Brickade', item1: 'Barrows dye', item2: 'Shadow dye'});
doubleBroadcasts.push({name: 'Grim Daniel', item1: 'Third Age dye', item2: 'Blood dye'});
doubleBroadcasts.push({name: 'Pretty14', item1: 'Backstab cape', item2: 'Barrows dye'});
doubleBroadcasts.push({name: 'Very afkable', item1: 'Third age druidic robe bottom', item2: 'Sack of effigies'});
doubleBroadcasts.push({name: 'xWannes', item1: 'Third age druidic robe top', item2: 'Barrows dye'});
doubleBroadcasts.push({name: 'Bhyske', item1: 'Barrows dye', item2: 'Backstab cape'});
...
.then(result => {
	...
	currentHeight += context.measureText(textConfig.text).actualBoundingBoxAscent + padding + 50;
	textConfig.yPosition = currentHeight;
	textConfig.xPosition = textCenter - context.measureText(textConfig.text).width/2;
	textOutput.push({...textConfig});
	// context.fillText(title, textCenter - context.measureText(title).width/2, currentHeight);

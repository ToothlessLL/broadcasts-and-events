...
/* paste here */
broadcasts.get(`Barrows dye`).data = {count: 141, value: 129164090};
broadcasts.get(`Shadow dye`).data = {count: 89, value: 1150000000};
broadcasts.get(`Ice dye`).data = {count: 79, value: 1050000000};
broadcasts.get(`Third Age dye`).data = {count: 14, value: 10000000000};
broadcasts.get(`Blood dye`).data = {count: 15, value: 11500000000};
...
broadcasts.get(`Backstab cape`).data = {count: 72, value: 2115896};
broadcasts.get(`Third age mage hat`).data = {count: 1, value: 200041007};
...
broadcasts.get(`Sack of effigies`).data = {count: 32, value: 2039460};
...
broadcasts.get(`Third age vambraces`).data = {count: 2, value: 202412479};
...
broadcasts.get(`Third age druidic robe bottom`).data = {count: 6, value: 194573379};
broadcasts.get(`Third age druidic staff`).data = {count: 6, value: 190480470};
broadcasts.get(`Third age druidic cloak`).data = {count: 10, value: 199784979};
...
const topGP = [{name: 'Jere', gp: 198311256894}, {name: 'Aidenn', gp: 134977981816}, {name: 'Finally', gp: 45626471471}];
const totalCaskets = 192434;
